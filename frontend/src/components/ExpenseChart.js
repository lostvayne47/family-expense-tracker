...
export default function ExpenseList({ groupId }) {
  ...
  return (
    <>
      <div className="max-w-3xl w-full mx-auto bg-gray-700 p-4 rounded-lg shadow-xl min-h-[562px]">
        ...
        <div className="h-[350px] border border-gray-300 rounded-lg p-3 flex items-center justify-center">
          {expenseLoading ? (
            <Loader />
          ) : groupExpensesData?.length > 0 ? (
            <ExpensePieChart expenses={groupExpensesData} />
          ) : (
